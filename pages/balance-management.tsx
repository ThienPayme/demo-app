import { Avatar, Button, Card, Col, Divider, Layout, Row } from "antd"
...
const BalanceManagement = () => {
    ...
    const renderItemTransaction = (item: any) => (
        <div key={item.key}>
            <Row justify="space-between" style={{ padding: '10px 20px' }} align='middle'>
                <Col >
                    <Row align="middle">
                        <Col>
                            <Avatar size={39} src={listImgs[item.img]} style={{ marginRight: 19 }} />
                        </Col>
                        <Col>
                            <div>
        ...
        <Layout>
            <Content style={{ background: 'white', height: '800px' }}>
                <Card title="Quản lí số dư" bordered={false} style={{ width: '100%' }}>
                    <Row justify="center">
                        <Col xl={13} lg={24} >
                            <Card style={{ borderRadius: 12, height: 120, marginBottom: '20px' }}>
                                <Row justify="space-between">
                                    <Col style={{ display: 'flex' }}>
                                        <Avatar size={62} src='http://dev-dashboard.payme.net.vn/assets/img/balances/ic-balances.png' />
                                    ...
                                    <Col>
                                        <Button size='large' type="primary" icon={<ArrowDownOutlined />} style={{ borderRadius: 12, background: '#e2fee5', color: '#00be00', border: '#fff', margin: '0 10px' }}>
                                            Nạp tiền
                                        </Button>
                                        <Button size='large' type="primary" icon={<ArrowUpOutlined />} style={{ borderRadius: 12, background: '#e6f6fa', color: '#39a7ff', border: '#fff', margin: '0 10px' }}>
                                            Rút tiền
                                        </Button>
                                    </Col>
                                </Row>
                            </Card>
                            <Card title='Lịch sử giao dịch' extra={renderActionHistory} style={{ padding: 0 }} >
